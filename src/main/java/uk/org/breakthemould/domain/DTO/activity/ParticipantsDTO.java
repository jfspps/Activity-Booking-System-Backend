...
import uk.org.breakthemould.domain.DTO.personnel.FamilyDTOList;
...
@JsonPropertyOrder({"id", "activityTemplate_dto", "freeMealPlacesLimit", "freeMealPlacesTaken", "nonFreeMealPlacesLimit",
        "nonFreeMealPlacesTaken", "meetingDateTime", "organiser", "meetingPlace", "otherSupervisors", "familyDTO"})
public class ParticipantsDTO {
    ...
    private FamilyDTOList familyDTOList;
}
