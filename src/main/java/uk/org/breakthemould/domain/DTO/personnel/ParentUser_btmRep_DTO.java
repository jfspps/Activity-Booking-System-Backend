...
@Data
@JsonPropertyOrder({"parentUsername", "btmRepUsername", "btmRepFirstName", "btmRepLastName"})
public class ParentUser_btmRep_DTO {

    private String parentUsername;

    private String btmRepUsername;

    private String btmRepFirstName;

    private String btmRepLastName;
}
